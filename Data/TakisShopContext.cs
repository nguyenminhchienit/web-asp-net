...
namespace TakisShop.Data;

public partial class TakisShopContext : DbContext
{
    public TakisShopContext()
    {
    }

    public TakisShopContext(DbContextOptions<TakisShopContext> options)
        : base(options)
    {
    }
